      ...
      <footer className="w-full bg-text-dark text-gray-400 py-8">
        <div className="container mx-auto px-4 flex flex-col items-center">
          <div className="flex flex-wrap justify-center gap-6 mb-6">
            <Link to="/regulamento" onClick={() => window.scrollTo(0, 0)} className="hover:text-white transition-colors">Regulamento</Link>
            <Link to="/privacidade" onClick={() => window.scrollTo(0, 0)} className="hover:text-white transition-colors">Política de Privacidade</Link>
            <Link to="/termos" onClick={() => window.scrollTo(0, 0)} className="hover:text-white transition-colors">Termos de Uso</Link>
            <Link to="/jogo-responsavel" onClick={() => window.scrollTo(0, 0)} className="hover:text-white transition-colors">Jogo Responsável</Link>
          </div>
